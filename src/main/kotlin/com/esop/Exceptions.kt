...
class TransactionTaxLessThanZeroException : Exception("Transaction tax cannot be less than zero")

class InvalidEsopTypeException : Exception("Invalid esopType")

class InvalidEsopQuantityException : Exception("ESOP quantity should be positive")

class InvalidEsopPriceException : Exception("ESOP price should be positive")