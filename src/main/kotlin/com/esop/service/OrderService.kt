...
class OrderService(
    ...
    private val taxCalculator: Chargeable,
    private val taxRecords: TaxRecords
) {
    companion object {
    ...
    private fun updateOrderDetails(
        ...
        val transactionTax =
            taxCalculator.calculateCharge(currentTradeQuantity, sellerOrder.getPrice(), sellerOrder.esopType)
        updateWalletBalances(sellAmount, platformFee, buyer, seller, transactionTax)
    ...
    private fun updateWalletBalances(
        ...
        val adjustedSellAmount = sellAmount - platformFee - transactionTax
        addPlatformFee(platformFee)
        taxRecords.addTransactionTax(transactionTax)
